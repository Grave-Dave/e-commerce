            ...
            <div className="container justify-center mx-auto flex flex-col md:flex-row items-center flex-wrap px-16">
                <div className="flex flex-col w-full justify-center items-center text-center lg:w-2/5 xl:items-start xl:text-left">
                    <p className="capitalize tracking-wide w-full text-xl xl:-mx-8">
                        Stylish Gear & Healthy Food for Your Pet.
                    </p>
                    <h2 className="my-5 text-4xl font-bold leading-tight xl:my-12 2xl:text-5xl">
                        Welcome To Pet E-Shop
                    </h2>
                    <p className="capitalize leading-normal text-xl xl:-mx-8 xl:self-end">
                        Everything you need for your best friend.
                    </p>
                </div>
                <div className="w-full flex justify-center text-center py-7 lg:w-3/5">
                    <img
                        src="/hero.png"
                        alt="hero section"
